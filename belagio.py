...
# open stream
print('y= wav file, n = Piano')
if keyboard.is_pressed('y'): #might be an error with indent btw 
    p = pyaudio.PyAudio()
...
if keyboard.is_pressed('y'):
  while True:
    if inp.poll():
        ...
        tl = TP[8:10]
        tk = int(tl)
        NoteFreq = 440 * (1.059463 ** ((tk * .93) - 52.5)) #https://www.desmos.com/calculator/yw21ozsz29
        print(IREAD)
        print(NoteFreq) #predicted note freq
    pygame.time.wait(10) #adjust to fit your liking
else:
